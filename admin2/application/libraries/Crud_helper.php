...
class Crud_helper{
  ...
  public static function delete_product($id){
    $booked = obj('booking_items')->count(['where'=>['product_id',$id]]);
    if($booked)
      return false;
    ...
    get_instance()->db->delete('customer_discounts', array('product_id' => $id));
    get_instance()->db->delete('product_discounts', array('product_id' => $id));
    get_instance()->db->delete('product_tax', array('product_id' => $id));
    get_instance()->db->delete('customer_tax', array('product_id' => $id));
