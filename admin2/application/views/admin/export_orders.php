...
<div class="row">
  <div class="col-lg-12">
    ...
    <table class="table table-striped">
      ...
      $status = $order->getExportOrderStatus($this->tank_auth->get_user_id());
      ...
      <h5 class='text-center'>
        ...
        <nav>
          ...
          <?php if(($orders['current_page'] <= $orders['last_page']) && $orders['current_page']!=1):?>
             <li><a href="<?=site_url('admin/export_orders'.$orders['prev_page_url'])?>">Previous</a></li>
           <?php endif;?>

             <?php if(($orders['last_page'] - $orders['current_page']) !=0):?>
                <li><a href="<?=site_url('admin/export_orders'.$orders['next_page_url'])?>">Next</a></li>
            <?php endif;?>
          </ul>
        </nav>    
