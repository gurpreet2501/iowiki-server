...
if(user_role()=='plant_manager'){
  $orderModel = Models\Orders::with('items.shippedQuantity')->WhereHasItemsFromPlant($this->tank_auth->get_user_id())
                          ->find($order['id']);
...
<div class="row">
  <div class="col-xs-6">
    ...
    <? if(user_role()=='plant_manager' && $orderModel->type != 'Export'):?>
