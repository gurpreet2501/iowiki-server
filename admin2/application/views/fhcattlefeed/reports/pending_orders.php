...
<div class="row">
  <div class="col-lg-12">
    ...
    <div class="text-center">
      <a  target="__blank"
          href='<?=site_url('reports/fhcattlefeed/pending_orders/print_version/?'.http_build_query(['filters'=>$filters]))?>' 
          class='btn btn-primary'>Print</a>
      <a  href='<?=site_url('reports/fhcattlefeed/pending_orders/csv?'.http_build_query(['filters'=>$filters]))?>' 
